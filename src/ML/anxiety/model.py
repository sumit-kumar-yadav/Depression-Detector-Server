...
data_path = os.path.join(os.getcwd(), "src/ML/anxiety", "anxiety_dataset.csv")
...
training_documents = documents[0:2500]
testing_documents = documents[2500:]
...
import pickle
pickle_file_path2 = os.path.join(os.getcwd(), "src/ML/anxiety", "temp2.pkl")
pickle_file_path3 = os.path.join(os.getcwd(), "src/ML/anxiety", "temp3.pkl")
pickle_file_path4 = os.path.join(os.getcwd(), "src/ML/anxiety", "temp4.pkl")
